...
//
//   - Push(SpeakerEvent) â€” invoked by the observer.
//   - Subscribe() â€” recorder/streaming consumers receive a channel of events.
//   - Snapshot() â€” point-in-time view of active and known speakers.
//
