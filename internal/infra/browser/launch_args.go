...
// in launchPersistentContext). Keep this list in sync ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â these flags were
...
func defaultArgs(opts domain.BrowserLaunchOptions) []string {
...
func ResolveChromePath(opts domain.BrowserLaunchOptions) string {
	if opts.ChromePath != "" {
