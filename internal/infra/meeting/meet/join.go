...
import (
	...
	perrors "github.com/PhucNguyen204/Meeting-BaaS/internal/pkg/errors"
...
func (p *Provider) JoinMeeting(ctx context.Context, page domain.Page, opts meeting.JoinOptions) error {
...
func typeBotNameWithRetry(ctx context.Context, page domain.Page, botName string, log *zap.Logger) error {
...
func clickJoinButton(page domain.Page, log *zap.Logger) {
...
func dismissPopups(page domain.Page, log *zap.Logger) {
...
func clickTextButton(page domain.Page, text string, log *zap.Logger) {
...
func toggleButton(page domain.Page, selector string, wantOn bool, log *zap.Logger) {
