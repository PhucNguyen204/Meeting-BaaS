...
//  3. Errors are logged but not fatal ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â cleanup closes the page anyway.
func (p *Provider) CloseMeeting(ctx context.Context, page domain.Page) error {
